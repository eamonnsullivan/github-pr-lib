...
(def get-repo-id-query (slurp "./resources/graphql/get-repo-id-query.graphql"))
(def create-pull-request-mutation (slurp "./resources/graphql/create-pull-request-mutation.graphql"))
(def search-for-pr-id-query (slurp "./resources/graphql/search-for-pr-id-query.graphql"))
(def update-pull-request-mutation (slurp "./resources/graphql/update-pull-request-mutation.graphql"))
(def mark-ready-for-review-mutation (slurp "./resources/graphql/mark-ready-for-review-mutation.graphql"))
(def add-comment-mutation (slurp "./resources/graphql/add-comment-mutation.graphql"))
(def edit-comment-mutation (slurp "./resources/graphql/edit-comment-mutation.graphql"))
(def close-pull-request-mutation (slurp "./resources/graphql/close-pull-request-mutation.graphql"))
(def reopen-pull-request-mutation (slurp "./resources/graphql/reopen-pull-request-mutation.graphql"))
(def merge-pull-request-mutation (slurp "./resources/graphql/merge-pull-request-mutation.graphql"))
(def pull-request-query (slurp "./resources/graphql/pull-request-query.graphql"))
(def search-for-issue-comment-id (slurp "./resources/graphql/search-for-issue-comment-id-query.graphql"))
